 ...
 */
export const fetchTenantTickets = async (): Promise<SupportTicket[]> => {
 ...
 */
export const fetchTicketById = async (ticketId: string | number): Promise<SupportTicketWithMessages> => {
 ...
 */
export const createTicket = async (subject: string, message: string): Promise<{ ticket: SupportTicket }> => {
 ...
 */
export const replyToTicket = async (ticketId: string | number, message: string): Promise<{ message: SupportMessage }> => {
